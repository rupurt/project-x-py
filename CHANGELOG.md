...
- **Realtime bar schema mismatch**: extra fields in the bars API response made
  ...
  width 6`) — spamming errors and freezing realtime timeframes. The realtime
  data manager now appends bars with diagonal concatenation, tolerating the
  wider historical schema (extra fields become null on realtime bars).
